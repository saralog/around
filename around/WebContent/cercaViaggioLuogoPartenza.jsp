...
String partenza=request.getParameter("cerca");
...
for (int i=0; i<list.size() ; i++){	
	...
	String luogoPartenza=list.get(i).getLuogoPartenza();
		...
		if(partenza.trim().equals(luogoPartenza)){
...
%>
<br>
nome del creatore passaggio <%=nome %><br>
id del viaggio<%=ID_viaggio %><br>
luogo di partenza del viaggio <%=luogoPartenza %>
<br>
<%}}
%>
